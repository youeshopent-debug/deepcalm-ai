...
export const CATEGORY_ORDER = ["sleep", "anxiety", "grief_loss", "loneliness", "self_worth", "relationships", "identity", "mindfulness", "emotional_health"]
...
export const CATEGORY_INTROS: Record<string, Record<Locale, string>> = {
  sleep: {
